    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDoSomethingCoolButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                EditText etTextEntry = (EditText) findViewById(R.id.et_text_entry);
                ...
                String textEntered = etTextEntry.getText().toString();
                startChildActivityIntent.putExtra(Intent.EXTRA_TEXT, etTextEntry.getText().toString());
